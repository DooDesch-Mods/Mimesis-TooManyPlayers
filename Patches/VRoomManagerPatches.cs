...
{
	/// <summary>
	/// Patches for VRoomManager to override player count checks when entering rooms.
	/// Uses transpiler to replace hardcoded 4 with configured max players.
	/// </summary>
	internal static class VRoomManagerPatches
	{
		[HarmonyPatch(typeof(VRoomManager), "EnterWaitingRoom")]
		internal static class EnterWaitingRoomPatch
		{
		...
		internal static class EnterMaintenenceRoomPatch
		{
			private static System.Collections.Generic.IEnumerable<CodeInstruction> Transpiler(
				System.Collections.Generic.IEnumerable<CodeInstruction> instructions)
			{
